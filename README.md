...
- [ ] Each user has an avatar
    - POC can be as simple as a dot with a username as long as it satisfies the following:
        - [ ] Users control their avatars position
        - [ ] Everyone can clearly see each other's avatars when convening in a location in a level
